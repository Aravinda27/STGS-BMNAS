...
def parse_args():
    ...
    parser.add_argument('--search_exp_dir', type=str, help='evaluate which search exp', default="/media/user1/8089c1c4-5bde-4b0d-abd1-ac7131e6ceb4/Aravind_data/codes/vinod/BM-NAS-master/final_exp/ntu/search-EXP-20240408-144300")
    ...
    parser.add_argument('--checkpointdir', type=str, help='output base dir',
                        default='/media/user1/8089c1c4-5bde-4b0d-abd1-ac7131e6ceb4/Aravind_data/codes/vinod/BM-NAS-master')
    parser.add_argument('--datadir', type=str, help='data directory',
                        default='/media/user1/8089c1c4-5bde-4b0d-abd1-ac7131e6ceb4/Aravind_data/codes/vinod/fakeavceleb_final_dataset/NTU')
    ...
    parser.add_argument('--num_outputs', type=int, help='output dimension', default=2)
