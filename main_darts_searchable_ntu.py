...
def parse_args():
    ...
    parser.add_argument('--ske_cp', type=str, help='Skeleton net checkpoint (assuming is contained in checkpointdir)',
                        default='spec_8frames_83.91.checkpoint')
    ...
    parser.add_argument('--use_dataparallel', help='Use several GPUs', action='store_true', default=True)
    parser.add_argument('--modality', type=str, help='', default='both')
    parser.add_argument('--parallel', help='Use several GPUs', action='store_true', default=True)
