...
def transform_input(x, dim, T=12):
    ...
    if diff > 0:
        ...
        x = x.view(-1, T, C, W, H)
        x = x.transpose(1, 2)
    #print("Video Tensor after transform:",x.shape)
    return x
