...
class FusionNetwork(nn.Module):
    ...
    def __init__(self, steps, multiplier, num_input_nodes, num_keep_edges, args, 
        ...
        #print("Criteriaon",self._criterion)
    ...
    def forward(self, input_features):
        ...
        #Apply Gumbel-Softmax relaxation with straight through estimator
        #weights = F.softmax(self.alphas_edges, dim=-1)
        weights=self.gumbel_softmax_sample(self.alphas_edges, num_sample = 15,temperature=10.0)
    ...
    def gumbel_softmax_sample(self, logits, num_sample,temperature):
            """
